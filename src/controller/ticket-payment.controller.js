import { getCardInfo, getTicketInfo, postTicket } from '../model/ticket-payment.model.js';
...
export const PostTicket = async (req, res) => {
    ...
    if (!wallet_balance || !is_paid || !ticket_id) {
...
export const PostCard = async (req, res) => {
    ...
    if (!wallet_balance || !is_paid || !purchase_id) {
